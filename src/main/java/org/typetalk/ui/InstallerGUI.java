...
public class InstallerGUI extends javax.swing.JFrame implements VoiceUpdateListener {
   ...
   public void setVisible(boolean b) {
      super.setVisible(b);
      if (b) {
         new Thread(() -> updateFromMaryComponentURL()).start();
      }
   }
   ...
   private void initComponents() {
      ...
      pDownloadLayout.setHorizontalGroup(pDownloadLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(pDownloadLayout.createSequentialGroup()
                  ...
                  .addContainerGap()));
      pDownloadLayout.setVerticalGroup(pDownloadLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
      ...
      pInstallButtonsLayout.setHorizontalGroup(pInstallButtonsLayout
            .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(org.jdesktop.layout.GroupLayout.TRAILING,
                  pInstallButtonsLayout.createSequentialGroup().add(146, 146, 146)
                        .add(bInstall, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                              org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .add(14, 14, 14).add(bUninstall).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(bUninstall1).add(194, 194, 194)));
      pInstallButtonsLayout
            .setVerticalGroup(pInstallButtonsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                  .add(pInstallButtonsLayout.createSequentialGroup().addContainerGap()
                        .add(pInstallButtonsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                              .add(bUninstall).add(bInstall).add(bUninstall1))
      ...
      layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(layout.createSequentialGroup()
                  ...
                  .add(jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                  .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(pInstallButtons,
   ...
   private HashSet<ComponentDescription> getAllInstalledComponents() {
      HashSet<ComponentDescription> components = new HashSet<>();
   ...
   private List<VoiceComponentDescription> getVoicesForLanguage(LanguageComponentDescription language) {
      List<VoiceComponentDescription> lVoices = new ArrayList<>();
   ...
   public void installSelectedLanguagesAndVoices() {
      ...
      Map<String, String> unmetDependencies = new TreeMap<>(); // map name to problem description
      ...
      int returnValue = JOptionPane.showConfirmDialog(this, "Install " + toInstall.size() + " components?\n("
            + MaryUtils.toHumanReadableSize(downloadSize) + " to download)", "Proceed with installation?",
   ...
   private boolean showLicenses(List<ComponentDescription> toInstall) {
      ...
      for (URL licenseURL : licenseGroups.keySet()) {
         ...
         final JOptionPane optionPane = new JOptionPane(licensePanel, JOptionPane.PLAIN_MESSAGE,
               JOptionPane.YES_NO_OPTION, null, new String[] { "Reject", "Accept" }, "Reject");
   ...
   private List<ComponentDescription> getComponentsSelectedForUninstall() {
      List<ComponentDescription> toUninstall = new ArrayList<>();
      for (String langName : languages.keySet()) {
         LanguageComponentDescription lang = languages.get(langName);
   ...
   private void findAndStoreSharedFiles(List<ComponentDescription> uninstallComponents) {
      ...
      Set<String> retainFiles = new TreeSet<>();
      ...
      for (ComponentDescription uninstallComponent : uninstallComponents) {
         Set<String> sharedFiles = new HashSet<>(uninstallComponent.getInstalledFileNames());
